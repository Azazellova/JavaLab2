...
<h4>inputInteger(Scanner input, String prompt)</h4>
<ul>
    <li><strong>Назначение:</strong> Ввод и валидация целочисленных значений</li>
    <li><strong>Параметры:</strong>
        <ul>
            <li><code>input</code> - объект Scanner для чтения ввода</li>
            <li><code>prompt</code> - сообщение для пользователя</li>
        </ul>
    </li>
    <li><strong>Возвращает:</strong> Валидное целое число</li>
    <li><strong>Особенности:</strong>
        <ul>
            <li>Циклически запрашивает ввод до получения корректного целого числа</li>
            <li>Обрабатывает некорректный ввод с выводом сообщения об ошибке</li>
        </ul>
    </li>
</ul>

<h4>inputDouble(Scanner input, String prompt)</h4>
<ul>
    <li><strong>Назначение:</strong> Ввод и валидация вещественных чисел</li>
    <li><strong>Параметры:</strong>
        <ul>
            <li><code>input</code> - объект Scanner для чтения ввода</li>
            <li><code>prompt</code> - сообщение для пользователя</li>
    ...
    <li><strong>Возвращает:</strong> Валидное вещественное число</li>
    <li><strong>Особенности:</strong>
        <ul>
            <li>Циклически запрашивает ввод до получения корректного числа с плавающей точкой</li>
            <li>Обрабатывает некорректный ввод с выводом сообщения об ошибке</li>
        </ul>
    </li>
</ul>

<h4>inputMark(Scanner input, String prompt)</h4>
<ul>
    <li><strong>Назначение:</strong> Ввод и валидация оценок</li>
    <li><strong>Параметры:</strong>
        <ul>
            <li><code>input</code> - объект Scanner для чтения ввода</li>
            <li><code>prompt</code> - сообщение для пользователя</li>
    ...
    <li><strong>Возвращает:</strong> Валидную оценку в диапазоне от 1 до 5</li>
    <li><strong>Особенности:</strong>
        <ul>
            <li>Проверяет как тип данных (целое число), так и допустимый диапазон значений</li>
            <li>Бесконечный цикл до получения корректной оценки</li>
            <li>Выводит сообщения об ошибках для разных случаев невалидного ввода</li>
        </ul>
    </li>
</ul>
...
int mark = Validation.inputMark(scanner, "Введите оценку: ");</code></pre>
